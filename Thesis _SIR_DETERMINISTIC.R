...
pop.SI <- c(S =0.99*N0,  # Initially 6.5% of the population is susceptible
            I = 1)       # ENTER THE NUMBER INITIALLY INFECTED (20.5)
...
values <- c(tau = 0.54,        # Transmission coefficient
            gamma = 0.076,       # 1 / infectious period = 1/5 days
...
plot(ts.sir$time,               # Time on the x axis
     ...
     main = "SIR deterministic",# Plot title
     xlim = c(0,100),           #
